...
{
    /// <summary>
    /// Takes in json and maps it to a given model.
    /// </summary>
    /// <typeparam name="T">What model to map to</typeparam>
    public static class WepayMapping<T>
    {

        /// <summary>
        /// Populates the model using the given json.
        /// </summary>
        /// <param name="json">The string representing the json object</param>
        /// <param name="parentToken">Used to find the location of the json if wrapped in other json</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// A method for WepayRbit model to be populated be the given json.
        /// </summary>
        /// <param name="json">The string representing the json object</param>
        /// <param name="parentToken">Used to find the location of the json if wrapped in other json</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// An async method for WepayBatch model to be populated be the given json.
        /// </summary>
        /// <param name="json">The string representing the json object</param>
        /// <returns></returns>
        public async static Task<List<WepayBatch>> AsyncMapBatchFromJson(string json)
        {
        ...
        /// <summary>
        /// Check if the object is an error else populate the WepayBatch object with the dynamic object.
        /// </summary>
        /// <param name="JsonCall">The dynamic object representing the json object</param>
        /// <returns></returns>
        private static WepayBatch MapBatchInnerLoop(dynamic JsonCall)
        {
        ...
        /// <summary>
        /// Fills out child model of WepayBatch base on the uri that is passed in.
        /// </summary>
        /// <param name="call">The string of what uri the call came from</param>
        /// <param name="referenceId">A unique string id that has been attach to the call</param>
        /// <param name="json">The string representing the json object</param>
        /// <returns></returns>
        private static WepayBatch WepayType(string call, string referenceId, string json)
        {
            switch (call)
            {
                #region oauth2
